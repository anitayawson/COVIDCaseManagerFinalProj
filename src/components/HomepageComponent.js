                    ...
                    <div className="login-section">
                        <div className="login-wrap">
                            <div className="login-html">
                                ...
                                <label for="tab-1" className="tab">Patient</label>
                                <input id="tab-2" type="radio" name="tab" className="sign-up" />
                                <label for="tab-2" className="tab">Health Professional</label>
                                <div className="login-form">
                                    <div className="sign-in-htm">
                                        ...
                                        <div class="group"><Link to="/test"><input type="submit" className="button" value="Sign In" /></Link></div>
                                        <div className="hr"></div>
                                        <div className="foot-lnk"><a href="#forgot">Forgot Password?</a>
