                    ...
                    <div className="login-section">
                        <div className="login-wrap">
                            <div className="login-html">
                                ...
                                <label htmlFor="tab-1" className="tab">Patient</label>
                                <input id="tab-2" type="radio" name="tab" className="sign-up" />
                                <label htmlFor="tab-2" className="tab">Health Professional</label>
                                <div className="login-form">
                                    <div className="sign-in-htm">
                                        <div className="group">
                                            ...
                                            <input
                                                id="username"
                                                type="text" className="input input_anim"
                                    ...
                                    <div className="sign-up-htm">
                                        <div className="group">
                                            <label htmlFor="user" class="label">Hospital ID</label>
