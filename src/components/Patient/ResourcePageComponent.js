        ...
        <div>
            ...
            <div style={{ marginLeft: 200, marginTop: 180, marginRight: 200, marginBottom: 5 }}>
                <div className="flex-container">
                    ...
                    <div className="flexbox-item long-vertical" style={{display: "flex", flexDirection: "column", fontSize: 40, fontWeight: "bold", backgroundColor: "#c9d3d1", color: "#A65656"}}>
                    ...
                    <div className="flexbox-item vertical2" style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <a style={{color: " #306161"}} href="112"> 112</a>
                        <a style={{color: " #306161"}} href="+233558439868">+233 55 843 9868</a>
                        <a style={{color: " #306161"}} href="+233509497700">+233 50 949 7700</a>
                    </div>
                </div>
            </div>
            <Footer />
